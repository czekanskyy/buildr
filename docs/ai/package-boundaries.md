...
| `core/expressions` | core | `parse`, `print`, `evaluate`, `typecheck`, `compileTemplate`, `stdlib` (the function list) | Lexer, Pratt parser | L0, `DataType` | Everything else | Unit + property + fuzz | Every resource limit has a test |
