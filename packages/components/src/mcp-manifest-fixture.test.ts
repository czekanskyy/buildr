...
// `@next-buildr/mcp` may not depend on this package (ADR-024), yet its serialization snapshots must run
...
// `UPDATE_MCP_FIXTURE=1 pnpm test --filter @next-buildr/components` after changing a component.
...
describe('the @next-buildr/mcp default manifest fixture', () => {
