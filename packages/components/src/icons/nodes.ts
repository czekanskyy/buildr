// Generated from lucide-static v1.48.0 (ISC License, see packages/components/LICENSE-lucide.txt). Path data only: the
// icons are rendered as React elements by <Icon>, never as an HTML string.
import type { IconNode } from './types.ts';

/** Icon name to the shapes it is drawn with, on a 24x24 grid, stroked with currentColor. */
